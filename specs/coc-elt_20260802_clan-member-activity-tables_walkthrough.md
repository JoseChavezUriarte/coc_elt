...
- **Deterministic Temporal Filtering**: Replaced nondeterministic runtime functions (`CURRENT_DATE()`, `CURRENT_TIMESTAMP()`) with deterministic timestamp parameters (`execution_ts = dataform.projectConfig.vars.execution_timestamp || "2026-08-02T12:00:00Z"`).
